...
A structured critique of an implementation plan artifact. Produced by a reviewer agent, then
consumed by the orchestrator to drive a conversation with the human before the plan is approved.
...
Path to the implementation plan being reviewed.
