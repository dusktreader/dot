...
-- vim.keymap.set("n", "<silent> <leader>t",   ":w<CR> :TestNearest --color=yes<CR>")
-- vim.keymap.set("n", "<silent> <leader>ts",  ":w<CR> :TestNearest --color=yes --capture=no<CR>")
-- vim.keymap.set("n", "<silent> <leader>tv",  ":w<CR> :TestNearest --color=yes --verbose<CR>")
-- vim.keymap.set("n", "<silent> <leader>tvv", ":w<CR> :TestNearest --color=yes --verbose --verbose<CR>")
-- vim.keymap.set("n", "<silent> <leader>T",   ":w<CR> :TestFile --color=yes --maxfail=1<CR>")
-- vim.keymap.set("n", "<silent> <leader>l",   ":w<CR> :TestLast --color=yes<CR>")
-- vim.keymap.set("n", "<silent> <leader>lv",  ":w<CR> :TestLast --color=yes --verbose<CR>")
-- vim.keymap.set("n", "<silent> <leader>lvv", ":w<CR> :TestLast --color=yes --verbose --verbose<CR>")
