...
`pyproject.toml` coverage configuration — running `uv run pytest tests/test_opencode_costs.py tests/test_cli_opencode_costs.py` exits with a coverage failure
